...
extern volatile uint32_t os_ticks;      ///< Stores scheduler's Flag (DONE, PENDING)
extern volatile uint8_t  os_task_index; ///< Holds index of the current task serviced by the scheduler
