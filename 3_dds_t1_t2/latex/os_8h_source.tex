...
\begin{DoxyCode}{0}
\DoxyCodeLine{1 }
\DoxyCodeLine{11 \textcolor{preprocessor}{\#ifndef OS\_H}}
\DoxyCodeLine{12 \textcolor{preprocessor}{\#define OS\_H}}
\DoxyCodeLine{13 }
\DoxyCodeLine{14 \textcolor{preprocessor}{\#define F\_CPU 16000000UL      }\textcolor{comment}{// Define Crystal Frequency of eYFi-\/Mega Board}}
\DoxyCodeLine{15 \textcolor{preprocessor}{\#include "{}Arduino.h"{}}}
\DoxyCodeLine{16 \textcolor{preprocessor}{\#include <stdio.h>}            \textcolor{comment}{// For NULL}}
\DoxyCodeLine{17 \textcolor{preprocessor}{\#include <avr/io.h>}           \textcolor{comment}{// Standard AVR IO Library}}
\DoxyCodeLine{18 \textcolor{preprocessor}{\#include <util/delay.h>}       \textcolor{comment}{// Standard AVR Delay Library}}
\DoxyCodeLine{19 \textcolor{preprocessor}{\#include <stdint.h>}}
\DoxyCodeLine{20 \textcolor{preprocessor}{\#include <avr/interrupt.h>}    \textcolor{comment}{// Standard AVR Interrupt Library}}
\DoxyCodeLine{21 }
\DoxyCodeLine{22 \textcolor{preprocessor}{\#define NUMBER\_OF\_TASKS     10}}
\DoxyCodeLine{23 }
\DoxyCodeLine{24 \textcolor{preprocessor}{\#define READY     0}}
\DoxyCodeLine{25 \textcolor{preprocessor}{\#define RUNNING   1}}
\DoxyCodeLine{26 \textcolor{preprocessor}{\#define SLEEPING  2}}
\DoxyCodeLine{27 }
...
\DoxyCodeLine{71 }
\DoxyCodeLine{72 }
\DoxyCodeLine{77 \textcolor{keywordtype}{void} \mbox{\hyperlink{os_8h_a6cc2e63d83267ff5059bf0a76b302a09}{os\_init}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{78 }
\DoxyCodeLine{79 }
\DoxyCodeLine{85 \textcolor{keywordtype}{void} \mbox{\hyperlink{os_8h_a64ca823d60335b83f74cc28378018058}{os\_start\_task}}(\textcolor{keywordtype}{void} (*ptr\_fn)());}
\DoxyCodeLine{86 }
\DoxyCodeLine{87 }
\DoxyCodeLine{94 \textcolor{keywordtype}{void} \mbox{\hyperlink{os_8h_ab93fff6139a40309204c3f4d9a05385f}{os\_delay}}(int32\_t delay\_ms);}
\DoxyCodeLine{95 }
\DoxyCodeLine{96 }
\DoxyCodeLine{105 \textcolor{keywordtype}{void} \mbox{\hyperlink{os_8h_ad89e53bc232b85604368e45d2469784f}{os\_scheduler\_sync}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{106 }
\DoxyCodeLine{107 }
\DoxyCodeLine{114 \textcolor{keywordtype}{void} \mbox{\hyperlink{os_8h_a3fc86ed91990cc04813ff7823fb4ffcd}{os\_scheduler}}(\textcolor{keywordtype}{void});}
\DoxyCodeLine{115 }
