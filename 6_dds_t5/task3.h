...
/**
 * @brief Displays a smile on a 4-digit cathode 7-segment display.
 * 
 */
...
/**
 * @brief Clears everything on the 4-digit 7-segment display.
 * 
 */
void seven_seg_clear_everything(void);
